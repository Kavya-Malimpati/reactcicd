			...
			<div className="bg-white rounded-lg shadow-xl w-full max-w-5xl max-h-screen overflow-auto" style={{ zIndex: '100' }}>
				...
				<div className="flex items-center justify-between px-6 py-4 ">
					...
					<div className="flex items-center space-x-2">
						<a href="http://localhost:5173/?Impersonation=true" target="_blank" className="bg-teal-500 hover:bg-teal-600 text-white px-4 py-2 rounded flex items-center text-sm">
							<svg
							...
							<div className="p-6 md:border-r border-gray-200 md:col-span-4">
								...
								<div className="grid grid-cols-2 gap-4 mt-6">
									<div>
										...
										<p className="text-sm">713.123.4567</p>
									</div>
									<div>
										<p className="text-sm text-gray-600 mb-1">
											Email
							...
							<div className="p-6 md:col-span-6">
								...
								<div className="grid grid-cols-3 gap-4">
									<div>
										...
										<p className="text-sm">{props.data.id} </p>
									</div>
									<div>
										<p className="text-sm text-gray-600 mb-1">
											Member Since
										</p>
										<p className="text-sm">Nov 21, 2019</p>
									</div>
									<div>
										<p className="text-sm text-gray-600 mb-1">
											Total Account Premium
										</p>
										<p className="text-sm">$12,345.67</p>
									</div>
								</div>
								...
								<div className="grid grid-cols-3 gap-4 mt-6">
									...
									<div>
										...
										<p className="text-sm">$1,030.33</p>
									</div>
								</div>
							</div>
						</div>
